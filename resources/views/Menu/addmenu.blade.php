...
<div class="card">
    <div class="card-body">
        <h2 style="color: #3399ff">Tambah Data Menu</h2>
        ...
        <div class="row">
            <div class="col-md-6">
                    ...
                    <div class="form-group">
                        ...
                        <input name="kode_produk" type="text" class="form-control" id="formGroupExampleInput">
                        @error('kode_produk')
                    ...
                    <div class="form-group">
                        ...
                        <input name="harga" type="text" class="form-control" id="formGroupExampleInput" pattern="[0-9]+" title="Harga harus berupa angka">
                        @error('harga')
                        <small class="form-text text-danger">{{$message}}</small>
                        @enderror
                    </div>
